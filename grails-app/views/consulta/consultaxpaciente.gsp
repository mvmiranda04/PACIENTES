    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link controller="consulta" action="createXpaciente" id="${consultaList[0].paciente?.id}">CreateNew</g:link></li>
            </ul>
        </div>
						...
						<tbody>
							<g:each in="${consultaList}" status="i" var="consultaInstance">
								...
								<td>${fieldValue(bean: consultaInstance, field: "tratamiento")}</td>
                                                ...
                                                <g:set var="idconsulta" value="${consultaInstance.id}" />
                                                <% println idmedicamento %>
                                                <div class="container">
                                                      <!-- Trigger the modal with a button -->
                                                      <button type="button" class="btn btn-primary btn-xs" data-id-paciente="${idconsulta}" data-toggle="modal" data-target="#myModal">Ver Medicamentos</button>
