...
<html>
    ...
    <body>
        ...
        <div id="show-medicamento" class="content scaffold-show" role="main">
            ...
            <f:display bean="medicamento" />
            <g:form resource="${this.medicamento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.medicamento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
